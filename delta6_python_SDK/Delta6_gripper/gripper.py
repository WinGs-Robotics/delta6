...
class Delta6Gripper(RTLoop):
    ...
    def set_mode(self, mode: str):
        """
        switch mode to "pos" or "torque"
        """
        if mode not in ["pos", "torque"]:
    ...
    def get_current_angular_vel(self):
        return self.current_motor_vel
...
if __name__ == "__main__":
    gripper = Delta6Gripper(motor_id=1, port='COM8', freq=10, mode="torque")
